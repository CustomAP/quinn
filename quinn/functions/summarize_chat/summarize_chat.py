	...
	try:
		if "phone_number" in event:
			...
			openAIClient.beta.threads.messages.create(
				...
				role = "user",
				content = "Now create a summary of this conversation and vector embeddings of all topics that you (his friend) can use to hold conversation or go back to the next time."
			)
